...
function getTextSizeData( canvas ){
	...
	t.canvasToTextHeightRatio = canvas.height / t.height;
	t.canvasToTextWidthRatio = canvas.width/ t.width;
...
function getTextAndCanvasComparison( canvas ){
...
var tplaneSq10a64 = new textPlane( "Hello!", 10, 10, 64, { x: 8, y: 15, z: 0 } );
