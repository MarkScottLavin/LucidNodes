...
function textPlane( text, xSize = 50, ySize = 25, fontsize = 64, position, color, backgroundColor, visible = true ){
	...
	createTextPlaneBufferGeom( this, width, ySize );
...
function createTextPlaneBufferGeom( textPlane, width, height ){
	
	textPlane.bufferGeom = new THREE.PlaneBufferGeometry( width, height, 1, 1); 
...
var textPlanes = {
	rec1b64: new textPlane( "Hello!", 12, 8, 100, { x: -54, y: 20, z: 0 }, { r: 11, g: 18, b: 70 }, { r: 255, g: 0, b: 0 } ),
	rec2b64: new textPlane( "Hello!", 12, 6, 64, { x: -40, y: 11, z: 0 }, { r: 255, g: 128, b: 0 }, { r: 255, g: 0, b: 0 } )
